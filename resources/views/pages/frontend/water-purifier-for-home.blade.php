    ...
    <section class="blog-single item-section">
        <div class="container">
            ...
            <div class="blog-pic text-center pb-5">
                <picture>
                    <img src="{{ asset('assets/frontend/img/water-purifier-for-home/1.webp') }}" alt="blog" class="">
                </picture>
            </div>
            ...
            <div class="blog-pic text-center">
                <picture>
                    <img src="{{ asset('assets/frontend/img/water-purifier-for-home/2.webp') }}" alt="blog" class="">
                </picture>
            </div>
