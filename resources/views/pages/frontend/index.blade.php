...
<body>
    ...
    <section class="banner-section">
        <div class="banner-bg" style="padding-bottom: 50px;">
            <div class="container">
                <div class="row">
                    <div class="col-8 text-left pt-5">
                        <div class="banner-title hide pt-5 ml-3">
                            ...
                            <p>
                                Embrace the Refreshing Difference. Elevate Your Hydration with Safe Aqua Tech's Premium
                                Water purifier.<br> Experience Purity in Every Sip
                            </p>
                    ...
                    <div class="col-12 col-sm-4 pt-3 pb-3" style="margin-top: 50px;">
                        <h5 class="two mr-4" style="color: white">Your Gateway to Quality Water <span
                                style ="color: #ffa922;">Providing Vital Details</span> for Your Purified Lifestyle.
                        </h5>
                        <form action="homemail.php" method="post" autocomplete="off">
                            <div class="form">
                                <div class="row">
                                    <div class="col-12 pt-2 pl-5">
                                        <input class="four" type="text" name="name"
                                    ...
                                    <div class="col-12 pl-5 pt-3">
                                        <input class="four" type="text" name="phone"
                        ...
                        <h6 class="two pt-4" style="color: white">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="support-title">
                        ...
                        <p>
                            At Safe Aqua Tech, we recognize the essential role of clean and safe drinking water in your
                            well-being. As a pioneering water purifier company, we are committed to delivering top-tier
                            water purifying solutions that adhere to the strictest health and safety criteria.
                        </p>
                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="support-content text-left">
                                    ...
                                    <div class="support-discription">
                                        ...
                                        <p>Cutting-edge tech for water purity. Our systems guarantee health-conscious
                                            hydration, sip after sip.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="support-content text-left">
                                    ...
                                    <div class="support-discription">
                                        ...
                                        <p>Seamless doorstep delivery. Enjoy pure water convenience with our purifiers
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="support-content text-left">
                                    ...
                                    <div class="support-discription">
                                        ...
                                        <p>Revitalize your health. Our purifiers nurture vitality, embracing a lifestyle
                                            of freshness and wellness.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="support-content text-left">
                                    ...
                                    <div class="support-discription">
                                        ...
                                        <p>Reliable guidance whenever needed. Count on us for assistance in meeting your
                                            purified water requirements</p>
                                    </div>
                                </div>
                            </div>
                        </div>
